...
export default function Shapes() {
    return (
        <div className = "rose-span-1 row-start-1 -mt-9 aspect-square md:col-span-1 md:col-start-2 md:mt-0">
...
function Geometries() {
    ...
    const soundEffects = [
        new Audio("/Sounds/knock5.wav"),
        new Audio("/Sounds/knock6.wav"),
        new Audio("/Sounds/knock7.wav"),
        new Audio("/Sounds/knock8.wav"),
        new Audio("/Sounds/knock9.wav"),
        new Audio("/Sounds/knock10.wav"),
        new Audio("/Sounds/knock11.wav"),
        new Audio("/Sounds/knock12.wav"),
    ];
